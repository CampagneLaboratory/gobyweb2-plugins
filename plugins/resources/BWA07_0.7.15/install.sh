...
function plugin_install_artifact {
    ...
    case ${id} in
        ...
        'EXECUTABLE' )
           VERSION="0.7.15"
            (
            ${RESOURCES_FETCH_URL_SCRIPT} http://downloads.sourceforge.net/project/bio-bwa/bwa-0.7.15.tar.bz2 bwa.tar.bz2
            bunzip2 bwa.tar.bz2
            tar -xvf bwa.tar
            cd   bwa-${VERSION}
            make
            ...
            if [ -e ${installation_path}/bwa ]; then
                return 0
            else
               return 127
            fi
        ...
        'INDEX' )
            ...
            BWA_EXEC=${RESOURCES_ARTIFACTS_BWA07_EXECUTABLE}/bwa
