...
function download_pluginsSDK {
   ...
   org/campagnelab/gobyweb/plugins/2.4.0/plugins-2.4.1-SNAPSHOT.jar ${installation_path}/plugins-2.4.1-SNAPSHOT.jar \
...
function download_filesets {
   ${RESOURCES_MAVEN_ARTIFACTS_DOWNLOADER_RUN_DOWNLOADER} ${CAMPAGNELAB_SNAPSHOT_REPO_URL} \
   org/campagnelab/gobyweb/filesets/1.3.0-SNAPSHOT/filesets-1.3.0-SNAPSHOT ${installation_path}/filesets-1.3.0-SNAPSHOT.jar \
   ${REPO_USER} ${REPO_PASSWORD}
}

function download_artifacts {
   ${RESOURCES_MAVEN_ARTIFACTS_DOWNLOADER_RUN_DOWNLOADER} ${CAMPAGNELAB_RELEASE_REPO_URL} \
   org/campagnelab/gobyweb/artifacts/2.3.0/artifacts-2.3.0.jar ${installation_path}/artifacts-2.3.0.jar \
   ${REPO_USER} ${REPO_PASSWORD}
}
...
function download_server_side_deps {
   ${RESOURCES_MAVEN_ARTIFACTS_DOWNLOADER_RUN_DOWNLOADER} ${CAMPAGNELAB_RELEASE_REPO_URL} \
   org/campagnelab/gobyweb/serverside-dependencies/1.0.9/serverside-dependencies-1.0.9-full.jar  ${installation_path}/serverside-dependencies-1.0.9-full.jar \
   ${REPO_USER} ${REPO_PASSWORD}
}
