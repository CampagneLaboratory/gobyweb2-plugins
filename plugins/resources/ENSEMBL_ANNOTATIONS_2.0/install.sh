...
function plugin_install_artifact {
    ...
    case ${id} in
        ...
        'ANNOTATIONS' )
            ...
            L=`pwd`
            set +e
            CACHED_FILE="/home/gobyweb/url-cache/biomart-packed-${ORGANISM}_${GENOME_REFERENCE_ID}_${ENSEMBL_RELEASE}.tar.gz"
            ...
            -cp ${RESOURCES_GOBYWEB_SERVER_SIDE_DEPENDENCIES_JAR}:${RESOURCES_GOBYWEB_SERVER_SIDE_ICB_GROOVY_SUPPORT_JAR}:${RESOURCES_GOBYWEB_SERVER_SIDE_COMMONS_IO_JAR}:${RESOURCES_ARTIFACTS_SAM_JDK_JAR}/sam-jdk.jar:${JOB_DIR} \
